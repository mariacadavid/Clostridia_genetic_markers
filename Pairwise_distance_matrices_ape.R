...
freq_dnak1=hist(dist_frame_dnak1$distances, breaks= 100, col="#22CEC6", xlab="Pairwise distance (dnaK1)", main="", xlim=c(0,1))
...
hist(dist_frame_dnak1$distances, breaks= 100, col="#22CEC6", xlab="Pairwise distance", main="", xlim=c(0,1))
dev.off()
...
freq_gyrb=hist(dist_frame_gyrb$distances, breaks= 100, col="#22CEC6", xlab="Pairwise distance (gyrB)", main="", xlim=c(0,1))
...
hist(dist_frame_gyrb$distances, breaks= 100, col="#22CEC6", xlab="Pairwise distance", main="", xlim=c(0,1))
dev.off()
...
freq_16s=hist(dist_frame_16s$distances, breaks= 100, col="#22CEC6", xlab="Pairwise distance (16s rRNA)", main="", xlim=c(0,1))
...
hist(dist_frame_16s$distances, breaks= 100, col="#22CEC6", xlab="Pairwise distance", main="", xlim=c(0,1))
dev.off()
